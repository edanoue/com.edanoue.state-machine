...
{
    public class TS_HybridGraph
    {
        [Test]
        public void BehaviourTreeInStateMachine()
        {
            // StateMachine を起動する
            ...
            Assert.That(blackboard.KickCounter, Is.EqualTo(0));

            graph.SendTrigger(Trigger.ToKick);
            graph.Update();
            ...
            Assert.That(blackboard.CombatEnterCount, Is.EqualTo(1));
            Assert.That(blackboard.CombatExitCount, Is.EqualTo(0));
            Assert.That(blackboard.PunchCounter, Is.EqualTo(2));
            Assert.That(blackboard.KickCounter, Is.EqualTo(3));
            ...
            Assert.That(blackboard.CombatExitCount, Is.EqualTo(0));
            Assert.That(blackboard.PunchCounter, Is.EqualTo(2));
            Assert.That(blackboard.KickCounter, Is.EqualTo(6));
        }
